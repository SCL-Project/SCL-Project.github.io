				...
				<Row>
					<Col md={{ span: 6 }}>
						<Form onSubmit={submitRegisterForm}>
							...
							<FormGroup className='mb-3'>
								<FormLabel htmlFor={'register-address'}>Address</FormLabel>
								<input
									type={'address'}
									className='form-control'
									id={'register-address'}
							...
							<FormGroup className='mb-3'>
								<FormLabel htmlFor={'register-city'}>City</FormLabel>
								<input
									type={'address'}
									className='form-control'
									id={'register-city'}
							...
							<FormGroup className='mb-3'>
								<FormLabel htmlFor={'register-plz'}>PLZ</FormLabel>
								<input
									type={'text'}
									className='form-control'
									id={'register-plz'}
							...
							<FormGroup className='mb-3'>
								<FormLabel htmlFor={'register-ahv_number'}>AHV-Number</FormLabel>
								<input
									type={'text'}
									className='form-control'
									id={'register-ahv_number'}
									name='ahv_number'
